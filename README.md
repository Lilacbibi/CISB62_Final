...
You can find the data here: <br>**Anime VS Cartoon VS Human**:<br>([https://en.wikipedia.org/wiki/Haiku](https://www.kaggle.com/datasets/hadiepratamatulili/anime-vs-cartoon-vs-human))
